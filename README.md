In order for the images to be displayed correctly, you will need a "secrets.xml" file inside the "res/values" folder with an Unsplash API secret as follows:
